...
> **Fork Notice:** This repository is a mirror of [bestruirui/octopus](https://github.com/bestruirui/octopus), published here to build and host a personal GHCR image (`ghcr.io/robs87/octopus`). All credit for the original project goes to [bestruirui](https://github.com/bestruirui).
...
```bash
docker run -d --name octopus -v /path/to/data:/app/data -p 8080:8080 ghcr.io/robs87/octopus:latest
```
