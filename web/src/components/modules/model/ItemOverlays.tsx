...
import { PriceFieldHint } from './PriceFieldHint';
        ...
        >
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                <label className="grid gap-1 text-xs text-muted-foreground">
                    <span className="flex items-center gap-1">
                        {t('cacheRead')}
                        <PriceFieldHint field="cacheRead" />
                    </span>
                    <Input
                        type="number"
                        step="any"
                ...
                <label className="grid gap-1 text-xs text-muted-foreground">
                    <span className="flex items-center gap-1">
                        {t('cacheWrite')}
                        <PriceFieldHint field="cacheWrite" />
                    </span>
                    <Input
                        type="number"
                        step="any"
